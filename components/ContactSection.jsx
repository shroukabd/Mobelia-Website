...
const posts = [
    {
        ...
        href: '#',
        description: 'Lorem ipsum dolor sit amet consectetur adipisicing e lit Animi illum est ipsum similique Possimus ration illum  autemdeserunt molestiae quasi non veritatis  asperiores',
        date: 'Mar 16, 2024',
        datetime: '2024-03-16',
    ...
    <div className='pt-12'>
       <div className="mx-auto max-x-7xl px-6 lg:px-8">
           ...
           variants={desVariants}
            className="mt-2 text-lg leading-8 text-muted-foreground">learn how grow your business with our export advance.

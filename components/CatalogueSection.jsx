...
export default function CatalogueSection() {
  const items = [
    {
        ...
        title: "Cossy living Setup",
        image: "/image/badroom.jpg",
        description: "family drowing room with a clean ",

    },
    {
        id: "02",
        catagory: "KITCHEN SETUP",
        title: "Cossy ketchen Setup",
  ...
  return (
    <div className=' gap-8 grid lg:grid-cols-4 md:grid-cols-2 lg:gap-0 divide-gray-300 lg:divide-x'>
      {
        items.map((item) => (
            <div key={item.id} 
            className='relative overflow-hidden group'>
                ...
                <div className='absolute top-0 p-4 bg-white text-black bg-opacity-60
                backdrop-blur m-4'>
               ...
               <div className='inset-0 bg-[#F8EDED] dark:bg-[#1F2544] flex-col items-center justify-end md:flex
